...
const riversideEvent: Event = {
  ...
  usageAreaSqm: 120,
  usageDays: 2,
  insuranceWanted: true,
  insuranceProviderId: 'ins-eventprotect',
  logisticsWanted: true,
  logisticsProviderId: 'log-setup',
  securityWanted: false,
  securityProviderId: '',
  sanitaryWanted: true,
  sanitaryProviderId: 'san-malteser',
  cateringWanted: true,
  cateringProviderId: 'cat-eventküche',
...
const studentEvent: Event = {
  ...
  usageDays: 1,
  insuranceWanted: true,
  insuranceProviderId: 'ins-allianz',
  logisticsWanted: true,
  logisticsProviderId: 'log-prolovent',
  securityWanted: true,
  securityProviderId: 'sec-secureevent',
  sanitaryWanted: true,
  sanitaryProviderId: 'san-johanniter',
  cateringWanted: true,
  cateringProviderId: 'cat-foodfest',
